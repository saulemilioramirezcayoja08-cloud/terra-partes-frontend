...
import { SaleService } from '../../../layout/pages/sale/services/sale-service';
import { sale_detail_response } from '../../../layout/pages/sale/models/response/sale-detail-response.model';
...
export class SalePrint implements OnInit {
  // dependencias
  ...
  // carga venta desde api por id de ruta
  private load_sale(): void {
    ...
    this.sale_service.get_sale(id).subscribe({
      next: (response) => {
