...
import { QuotationService } from '../../../layout/pages/quotation/services/quotation-service';
import { quotation_detail_response } from '../../../layout/pages/quotation/models/response/quotation-detail-response.model';
...
export class QuotationPrint implements OnInit {
  ...
  // carga cotizacion desde api por id de ruta
