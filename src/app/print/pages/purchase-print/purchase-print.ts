...
import { PurchaseService } from '../../../layout/pages/purchase/services/purchase-service';
import { purchase_detail_response } from '../../../layout/pages/purchase/models/response/purchase-detail-response.model';
...
export class PurchasePrint implements OnInit {
  ...
  // carga compra desde api por id de ruta
